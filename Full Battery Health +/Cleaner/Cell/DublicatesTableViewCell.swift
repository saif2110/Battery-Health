...
class DublicatesTableViewCell: UITableViewCell, UICollectionViewDataSource, UICollectionViewDelegate {
  ...
  func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
    ...
    guard let cell = collectionView.cellForItem(at: indexPath) as? DublicateCollectionViewCell else {
      return
    }
    
   // dubsCollectionView.reloadData()
    for i in collectionView.visibleCells{
      let cell = i as? DublicateCollectionViewCell
      cell?.selectedImageview.image = #imageLiteral(resourceName: "state-layer")
    }
    
    cell.selectedImageview.image = #imageLiteral(resourceName: "state-layer-untick.png")
  ...
  func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    ...
    cell.photoAsset = self.duplicates![indexPath.item]
    cell.selectedImageview.image = selectedImageIndex == indexPath.item ? #imageLiteral(resourceName: "state-layer-untick.png") : #imageLiteral(resourceName: "state-layer")
    cell.reload()
